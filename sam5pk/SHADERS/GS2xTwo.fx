/* ############################################################################################
   ...
   GS2xTwo shader(linear) - Copyright (C) 2007 guest(r) - guest.r@gmail.com
...

{
	...
	half w1=dot(abs(c22-c11),dt)+0.001;
	half w2=dot(abs(c02-c11),dt)+0.001;
	half w3=dot(abs(c00-c11),dt)+0.001;
	half w4=dot(abs(c20-c11),dt)+0.001;
